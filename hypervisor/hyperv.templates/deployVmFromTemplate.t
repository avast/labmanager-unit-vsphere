...
$user = "{{SVC_USER_NAME}}"
$passwd = "{{SVC_USER_PASSWD}}"

Invoke-command -credential (New-Object System.Management.Automation.PSCredential ($user, (ConvertTo-SecureString $passwd -AsPlainText -Force))) -computername ((Get-LeastLoadedHost).Name) -scriptblock {
    ...
    Set-VM -Name $newVmName -ComputerName $targetHost -ProcessorCount $cpuCount
...
#eof - several newlines at the end of the script must remain there
